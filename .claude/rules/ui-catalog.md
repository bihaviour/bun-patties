...
- **Specs** live in the sibling `bun-patties-docs` repo under `agent_specs/ui/archive/` (phases 0–4, all archived); `00-overview.md` is the catalog index. Parity against upstream shadcn is tracked in `agent_specs/research/shadcn-parity-matrix.md`.
