import type { RegisteredAgent, RegisteredJob, RegisteredTool, AgentConfig, ToolConfig, JobConfig } from "./types.ts"
...
export function registerTool(config: ToolConfig<any, any>, filePath?: string): void {
