...
import { createAiContext, type CreateAiContextOptions } from "./context.ts"

// Populates ctx.aiContext on every request. Registered automatically by the
// router when the agent/tool registry is non-empty.
export function createAiContextMiddleware(defaults: CreateAiContextOptions = {}): Middleware {
